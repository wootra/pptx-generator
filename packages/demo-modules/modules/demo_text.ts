...
export function genSlides_Text(pptx: PptxGenJS) {
	pptx.addSection({ title: 'Text' } as SectionProps);
...
function genSlide01(pptx: PptxGenJS) {
	...
	slide.addTable(
		[
			[
				{
					text: 'Text Examples: Text alignment, percent x/y, etc.',
	...
	slide.addText(
		[
			{
				text: 'Textbox align (center/middle)',
				options: { fontSize: 32, breakLine: true },
			},
			{
				text: 'Character Spacing 16',
				options: { fontSize: 16, charSpacing: 16, breakLine: true },
			},
			{
				text: 'Transparency 50%',
				options: { fontSize: 16, transparency: 50 },
			},
		],
		{
			x: 0.5,
	...
	let objOptions: TextPropsOptions = {
		x: 0,
		y: 7,
		w: '100%',
		h: 0.5,
...
function genSlide02(pptx: PptxGenJS) {
	...
	slide.addTable(
		[
			[
				{
					text: 'Text Examples: Multi-Line Formatting, Line Breaks, Line Spacing',
					options: BASE_TEXT_OPTS_L,
				},
				BASE_TEXT_OPTS_R,
			] as TableCell[],
	...
	slide.addText('Word-Level Formatting:', {
		x: 0.5,
		y: 0.6,
		w: '40%',
		h: 0.3,
	...
	slide.addText('Line-Spacing (text):', {
		x: 7.0,
		y: 2.7,
		w: '40%',
		h: 0.3,
	...
	slide.addText(
		'lineSpacing (Exactly)\n40pt',
		{
			...
			color: '363636',
			lineSpacing: 39.9,
		} // TEST-CASE: `lineSpacing` decimal value
	);
	...
	slide.addText('Line-Spacing (bullets):', {
		x: 7.0,
		y: 5.6,
		w: '40%',
		h: 0.3,
...
function genSlide03(pptx: PptxGenJS) {
	...
	slide.addTable(
		[
			[
				{ text: 'Text Examples: Bullets', options: BASE_TEXT_OPTS_L },
				BASE_TEXT_OPTS_R,
			] as TableCell[],
		],
		BASE_TABLE_OPTS
	...
	slide.addText('Bullet Indent-Levels:', {
		x: 0.5,
		y: 0.6,
		w: '40%',
		h: 0.3,
	...
	slide.addText('Bullet Spacing (Indentation):', {
		x: 0.5,
		y: 3.5,
		w: '40%',
		h: 0.3,
	...
	// 1: Regular bullets
	slide.addText('Bullet "Start At" number option:', {
		x: 7.0,
		y: 0.6,
		w: 5.75,
		h: 0.3,
	...
	slide.addText('Bullets made with line breaks:', {
		x: 7.0,
		y: 1.95,
		w: 5.75,
		h: 0.3,
	...
	slide.addText('Bullets and soft-line-break (shift+enter):', {
		x: 7.0,
		y: 3.5,
		w: 5.75,
		h: 0.3,
	...
	slide.addText(
		[
			...
			{
				text: 'Third line via `softBreakBefore:true`',
	...
	slide.addText('Bullets with text objects:', {
		x: 7.0,
		y: 5.05,
		w: 5.75,
		h: 0.3,
	...
	slide.addText(
		[
			...
			{
				text: 'match formatting as well.',
				options: { fontSize: 16, color: '00CD00' },
			},
		],
		{
			x: 7.0,
...
function genSlide04(pptx: PptxGenJS) {
	...
	slide.addTable(
		[
			[
				{
					text: 'Text Examples: Hyperlinks, Tab Stops, Text Effects: Shadow, Outline, and Glow',
					options: BASE_TEXT_OPTS_L,
				},
				BASE_TEXT_OPTS_R,
			] as TableCell[],
	...
	slide.addText('type:outer, offset:10, blur:3', {
		x: 7.5,
		y: 6.2,
		w: 5.5,
		h: 1.1,
...
function genSlide05(pptx: PptxGenJS) {
	...
	slide.addTable(
		[
			[
				{ text: 'Text Examples: Text Fit', options: BASE_TEXT_OPTS_L },
				BASE_TEXT_OPTS_R,
			] as TableCell[],
		],
		BASE_TABLE_OPTS
	...
	slide.addText(LOREM_IPSUM_ENG.substring(0, 1200), {
		x: 0.5,
		y: 1.3,
		w: 4,
		h: 4,
...
function genSlide06(pptx: PptxGenJS) {
	...
	slide.addTable(
		[
			[
				{
					text: 'Text Examples: Scheme Colors',
					options: BASE_TEXT_OPTS_L,
				},
				BASE_TEXT_OPTS_R,
			] as TableCell[],
	...
	slide.addText('TEXT1 on BACKGROUND2', {
		x: 0.5,
		y: 0.7,
		w: 6.0,
		h: 2.0,
	...
	slide.addText('TEXT2 on BACKGROUND1', {
		x: 7.0,
		y: 0.7,
		w: 6.0,
		h: 2.0,
		color: pptx.colors.TEXT2,
		fill: { color: pptx.colors.BACKGROUND1 },
	});

	slide.addText('ACCENT1', {
		x: 0.5,
		y: 3.25,
		w: 6.0,
		h: 1.0,
