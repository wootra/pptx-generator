...
import PptxGenJS, { IChartOpts, SectionProps } from 'gen-pptx-js';

export function genSlides_Master(pptx: PptxGenJS) {
	pptx.addSection({ title: 'Masters' } as SectionProps);
...
function genSlide03(pptx: PptxGenJS) {
	...
	slide.addText(
		[
			{
				text: 'Pre-filled placeholder bullets',
				options: { bullet: true, valign: 'top' },
			},
			{
				text: 'Add any text, charts, whatever',
				options: { bullet: true, indentLevel: 1, color: '0000AB' },
			},
			{
				text: 'Check out the online API docs for more',
				options: { bullet: true, indentLevel: 2, color: '0000AB' },
			},
		],
...
//  * @param {PptxGenJS} pptx
//  */
// export function genSlide07(pptx: PptxGenJS) {
...
// 			bkgd: {
// 				path: 'https://raw.githubusercontent.com/gitbrent/PptxGenJS/v2.1.0/examples/images/title_bkgd_alt.jpg',
// 			},
// 		});
