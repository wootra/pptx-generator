...
export interface ShapeProps extends PositionProps, ObjectNameProps {
	 ...
	 */
	fill?: ShapeFillProps | SCHEME_COLOR_NAMES;
	/**
...
export interface TableProps
	 ...
	 */
	border?: BorderProps | (BorderProps | null)[];
	/**
...
export interface TextProps {
	text?: string;
	options: TextPropsOptions | undefined;
}
...
export interface WriteProps extends WriteBaseProps {
	 ...
	 * @default 'blob'
	 */
	outputType?: WRITE_OUTPUT_TYPE | null;
}
...
export interface SlideBaseProps {
	 ...
	 * @deprecated v3.3.0 - use `background`
	 */
	bkgd?: string | BackgroundProps | null;
}
...
export interface PresSlide extends SlideBaseProps {
	...
	addText: (
		...
		options?: TextPropsOptions & ShapeProps
	) => PresSlide;
	 ...
	 */
	slideNumber?: SlideNumberProps | null;
}
