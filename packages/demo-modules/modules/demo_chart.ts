...
// SLIDE 11: Area Chart
function genSlide11(pptx: PptxGenJS) {
	let slide = pptx.addSlide({ sectionTitle: 'Charts' });
	slide.addNotes(
		'API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html'
	);
	...
	slide.addChart(
		pptx.charts.AREA,
		CHART_DATA.CeoPayRatio_Comp.chartData,
		optsChartLine1
	);
...
function genSlide18(pptx: PptxGenJS) {
	let slide = pptx.addSlide({ sectionTitle: 'Charts' });
	slide.addNotes(
		'API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html'
	);
...
function devSlide01(pptx: PptxGenJS) {
...
function devSlide05(pptx: PptxGenJS) {
	let slide = pptx.addSlide({ sectionTitle: 'Charts-DevTest' });
	slide.addNotes(
		'API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html'
	);
