...
export var LINEH_MODIFIER = 1.67; // AKA: Golden Ratio Typography
export var DEF_BULLET_MARGIN = 27;
export var DEF_CELL_BORDER = { type: 'solid', color: '666666', pt: 1 };
export var DEF_CELL_MARGIN_PT = [3, 3, 3, 3]; // TRBL-style // DEPRECATED 3.8.0
export var DEF_CELL_MARGIN_IN = [0.05, 0.1, 0.05, 0.1]; // "Normal" margins in PPT-2021 ("Narrow" is `0.05` for all 4)
export var DEF_CHART_BORDER = { type: 'solid', color: '363636', pt: 1 };
export var DEF_CHART_GRIDLINE = { color: '888888', style: 'solid', size: 1, cap: 'flat' };
export var DEF_FONT_COLOR = '000000';
export var DEF_FONT_SIZE = 12;
export var DEF_FONT_TITLE_SIZE = 18;
export var DEF_PRES_LAYOUT = 'LAYOUT_16x9';
export var DEF_PRES_LAYOUT_NAME = 'DEFAULT';
export var DEF_SHAPE_LINE_COLOR = '333333';
...
export var DEF_TEXT_GLOW = { size: 8, color: 'FFFFFF', opacity: 0.75 };
