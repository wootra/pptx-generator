...
import { BARCHART_COLORS, CHART_TYPE, DEF_CELL_BORDER, DEF_CELL_MARGIN_IN, DEF_CHART_BORDER, DEF_FONT_COLOR, DEF_FONT_SIZE, DEF_SHAPE_LINE_COLOR, DEF_SLIDE_MARGIN_IN, EMU, IMG_PLAYBTN, MASTER_OBJECTS, PIECHART_COLORS, SHAPE_TYPE, SLIDE_OBJECT_TYPES, TEXT_HALIGN, TEXT_VALIGN, } from './core-enums';
 ...
 */
export function createSlideMaster(props, target) {
 ...
 * }
 */
export function addChartDefinition(target, type, data, opt) {
    var _a;
    ...
    if (![
        ...
        'square',
        'triangle',
    ].includes(options.lineDataSymbol || '')) {
    ...
    if (!options.dataLabelFormatScatter &&
        options._type === CHART_TYPE.SCATTER) {
 ...
 */
export function addImageDefinition(target, opt) {
    var newObject = {
        _type: null,
        text: null,
        options: null,
    ...
    var objectName = opt.objectName
        ...
        : "Image ".concat(target._slideObjects.filter(function (obj) { return obj._type === SLIDE_OBJECT_TYPES.image; }).length);
    // REALITY-CHECK:
 ...
 */
export function addMediaDefinition(target, opt) {
    var intPosX = opt.x || 0;
    var intPosY = opt.y || 0;
    ...
    var objectName = opt.objectName
        ? encodeXmlEntities(opt.objectName)
        : "Media ".concat(target._slideObjects.filter(function (obj) { return obj._type === SLIDE_OBJECT_TYPES.media; }).length);
 ...
 * @since 2.3.0
 */
export function addNotesDefinition(target, notes) {
 ...
 */
export function addShapeDefinition(target, shapeName, opts) {
    ...
    } // @deprecated (part of `ShapeLineProps` now)
 ...
 */
export function addTableDefinition(target, tableRows, options, slideLayout, presLayout, addSlide, getSlide) {
        ...
        if (Array.isArray(row)) {
            row.forEach(function (cell) {
                ...
                var newCell = {
                    ...
                    text: '',
                    options: typeof cell === 'object' && cell.options
                        ? cell.options
                        : {},
                };
                // B:
                ...
                if (!Array.isArray(cellBorder) &&
                    typeof cellBorder === 'object') {
                ...
                arrSides.forEach(function (idx) {
                    ...
                    newCell.options.border[idx] = {
                        type: ((_a = newCell.options.border[idx]) === null || _a === void 0 ? void 0 : _a.type) ||
                            DEF_CELL_BORDER.type,
                        color: ((_b = newCell.options.border[idx]) === null || _b === void 0 ? void 0 : _b.color) ||
                            DEF_CELL_BORDER.color,
                        pt: typeof ((_c = newCell.options.border[idx]) === null || _c === void 0 ? void 0 : _c.pt) === 'number'
                            ? (_d = newCell.options.border[idx]) === null || _d === void 0 ? void 0 : _d.pt
                            : DEF_CELL_BORDER.pt,
                    };
                });
                // LAST:
    ...
    opt.margin =
        opt.margin === 0 || opt.margin ? opt.margin : DEF_CELL_MARGIN_IN;
    ...
    */
    ...
    if (opt && !opt.autoPage) {
        ...
        getSlidesForTableRows(arrRows, opt, presLayout, slideLayout).forEach(function (slide, idx) {
            ...
            if (idx > 0) {
                opt.y = inch2Emu(opt.autoPageSlideStartY ||
                    opt.newSlideStartY ||
                    arrTableMargin[0]);
            }
 ...
 * @since: 1.0.0
 */
export function addTextDefinition(target, text, opts, isPlaceholder) {
    var newObject = {
        _type: isPlaceholder
    ...
    function cleanOpts(itemOpts) {
        // STEP 1: Set some options
        {
            ...
            itemOpts.lineSpacingMultiple =
                itemOpts.lineSpacingMultiple &&
                    !isNaN(itemOpts.lineSpacingMultiple)
                    ? itemOpts.lineSpacingMultiple
                    : null;
            ...
            itemOpts._bodyProp.anchor = !itemOpts.placeholder
                ? TEXT_VALIGN.ctr
                : null; // VALS: [t,ctr,b]
            ...
            if (typeof itemOpts.underline === 'boolean' &&
                itemOpts.underline === true) {
 ...
 */
export function addPlaceholdersToSlideLayouts(slide) {
        ...
        if (slideLayoutObj._type === SLIDE_OBJECT_TYPES.placeholder) {
            ...
            if (slide._slideObjects.filter(function (slideObj) {
                return slideObj.options &&
                    slideObj.options.placeholder ===
                        slideLayoutObj.options.placeholder;
            }).length === 0) {
 ...
 */
export function addBackgroundDefinition(props, target) {
    var _a;
    // A: @deprecated
    if (target.bkgd) {
