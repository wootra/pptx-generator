 ...
 * BLD.: 20210421
 */
import PptxGenJS, { TextProps, TextPropsOptions } from 'gen-pptx-js';
...
export function createMasterSlides(pptx: PptxGenJS) {
	...
	const TEXT_PROPS: TextPropsOptions = {
 ...
 */
export function testSlideBackgrounds(pptx: PptxGenJS) {
	let slide1 = pptx.addSlide();
	slide1.bkgd = '909090';
	slide1.addText([{ text: 'TEST `bkgd:string`' }] as TextProps[], {
		x: 1,
		y: 1,
		w: '80%',
		h: 3,
	...
	slide2.addText([{ text: 'TEST `background.fill`' }] as TextProps[], {
		x: 1,
		y: 1,
		w: '80%',
		h: 3,
	...
	slide3.addText([{ text: 'TEST `background`[correct]' }] as TextProps[], {
		x: 1,
		y: 1,
		w: '80%',
		h: 3,
