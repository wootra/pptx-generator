import { TABLE_NAMES_F, DEMO_TITLE_OPTS, DEMO_TITLE_TEXT, DEMO_TITLE_TEXTBK, BASE_OPTS_SUBTITLE, BASE_TABLE_OPTS, BASE_TEXT_OPTS_L, BASE_TEXT_OPTS_R, LOREM_IPSUM, } from './enums';
...
function genSlide02(pptx) {
    ...
    ], { x: '4%', y: '2%', w: '95%', h: '4%' }); // QA: this table's x,y,w,h all using %
...
function genSlide05(pptx) {
    ...
    slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-tables.html');
    slide.addText('The following textbox and table cell use the same array of text/options objects, making word-level formatting familiar and consistent across the library.', { x: 0.5, y: 0.5, w: '95%', h: 0.5, margin: 0.1, fontSize: 14 });
    slide.addText('[\n' +
...
function genSlide07(pptx) {
    ...
    ];
    {
        ...
        TABLE_NAMES_F.forEach(function (name, idx) {
            var strText = idx == 0
    ...
    // EX-3: "Master Page with Auto-Paging"
    {
        ...
        slide.newAutoPagedSlides.forEach(function (slide) {
            return slide.addText('Auto-Paging table continued...', {
                placeholder: 'footer',
            });
        });
    }
...
function genSlide09(pptx) {
    ...
    for (var rowIdx = 0; rowIdx < 9; rowIdx++) {
        ...
        for (var lineIdx = 0; lineIdx < 9; lineIdx++) {
            col3Lines.push({
                text: "This is ROW#:".concat(rowIdx + 1, " LNE#:").concat(lineIdx + 1),
...
//# sourceMappingURL=demo_table.js.map