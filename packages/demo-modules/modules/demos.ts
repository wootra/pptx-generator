...
export function runEveryTest(pptxgen?: PptxGenJS) {
...
export function execGenSlidesFuncs(type: string[], pptxgen?: PptxGenJS) {
	// STEP 1: Instantiate new PptxGenJS object
	// @ts-ignore
	let pptx = pptxgen !== undefined ? new pptxgen() : new PptxGenJS();
