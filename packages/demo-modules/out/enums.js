 ...
 */
// LIBRARY
export var TESTMODE = typeof window !== 'undefined' &&
    window.location &&
    window.location.href.toLowerCase().indexOf('http://localhost:8000/') > -1;
export var COMPRESS = true; // TEST: `compression` write prop
// CONST
export var CUST_NAME = 'S.T.A.R. Laboratories';
export var USER_NAME = 'Barry Allen';
export var ARRSTRBITES = [130];
export var CHARSPERLINE = 130; // "Open Sans", 13px, 900px-colW = ~19 words/line ~130 chars/line
// TABLES
export var TABLE_NAMES_F = [
    'Markiplier',
    'Jack',
    'Brian',
    'Paul',
...
export var BASE_TABLE_OPTS = { x: 0.5, y: 0.13, colW: [9, 3.33] }; // LAYOUT_WIDE w=12.33
// STYLES
export var BKGD_LTGRAY = 'F1F1F1';
export var COLOR_BLUE = '0088CC';
export var CODE_STYLE = {
...
// OPTIONS
export var BASE_TEXT_OPTS_L = {
    color: '9F9F9F',
    margin: 3,
    border: [null, null, { pt: 1, color: 'CFCFCF' }, null],
};
export var BASE_TEXT_OPTS_R = {
    text: 'PptxGenJS',
    options: {
        color: '9F9F9F',
        margin: 3,
...
export var DEMO_TITLE_TEXT = { fontSize: 14, color: '0088CC', bold: true };
export var DEMO_TITLE_TEXTBK = {
    fontSize: 14,
    color: '0088CC',
    bold: true,
    breakLine: true,
};
export var DEMO_TITLE_OPTS = { fontSize: 13, color: '9F9F9F' };
// PATHS
export var IMAGE_PATHS = {
    ...
    sample_aif: {
        path: 'https://raw.githubusercontent.com/gitbrent/PptxGenJS/master/demos/common/media/sample.aif',
    },
    sample_avi: {
