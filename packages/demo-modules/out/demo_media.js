 ...
 */
import { IMAGE_PATHS, BASE_TABLE_OPTS, BASE_TEXT_OPTS_L, BASE_TEXT_OPTS_R, BASE_CODE_OPTS, CODE_STYLE, TITLE_STYLE, } from './enums';
import { COVER_AUDIO, COVER_AUDIO_ROUND, COVER_VIDEO_16X9, COVER_VIDEO_MP4, COVER_YOUTUBE, } from './media';
...
function genSlide01(pptx) {
    var slide = pptx.addSlide({ sectionTitle: 'Media' });
    slide.addTable([
        [
            {
    ...
    slide.addText([{ text: 'Type: m4v' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 0.5, y: 0.6, h: 0.4, w: 3.56 }), TITLE_STYLE));
    slide.addMedia({
        x: 0.5,
        y: 1.0,
        h: 2.0,
    ...
    slide.addText([{ text: '`cover` image provided' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 0.5, y: 3.0, h: 0.4, w: 3.56 }), CODE_STYLE));
    slide.addText([{ text: 'Type: m4v' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 9.3, y: 0.6, h: 0.4, w: 3.56 }), TITLE_STYLE));
    slide.addMedia({
        x: 9.3,
        y: 1.0,
        h: 2.0,
    ...
    slide.addText([{ text: 'no `cover` image provided' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 9.3, y: 3.0, h: 0.4, w: 3.56 }), CODE_STYLE));
    // BOTTOM-ROW
    slide.addText([{ text: 'Type: mp4' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 0.5, y: 3.85, h: 0.4, w: 3.6 }), TITLE_STYLE));
    slide.addMedia({
        x: 0.5,
        y: 4.25,
        h: 2.7,
    ...
    slide.addText([{ text: 'Type: avi' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 4.79, y: 3.85, h: 0.4, w: 3.6 }), TITLE_STYLE));
    slide.addMedia({
        x: 4.79,
        y: 4.25,
        h: 2.7,
    ...
    slide.addText([{ text: 'Type: mov' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 9.08, y: 3.85, h: 0.4, w: 3.75 }), TITLE_STYLE));
    slide.addMedia({
        x: 9.08,
        y: 4.25,
        h: 2.7,
...
function genSlide02(pptx) {
    ...
    slide.addTable([
        [
            {
                text: 'Media Examples: Audio Types',
                options: BASE_TEXT_OPTS_L,
            },
            BASE_TEXT_OPTS_R,
        ],
    ], BASE_TABLE_OPTS);
    slide.addText([{ text: 'Type: mp3' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 0.5, y: 0.6, h: 0.4, w: 3.5 }), TITLE_STYLE));
    slide.addMedia({
        x: 0.5,
        y: 1.0,
        h: 3.5,
    ...
    slide.addText([{ text: 'Type: aiff' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 4.92, y: 0.6, h: 3.9, w: 3.5 }), TITLE_STYLE));
    slide.addMedia({
        x: 4.92,
        y: 1.0,
        h: 3.5,
    ...
    slide.addText([{ text: 'Type: wav' }], __assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 9.33, y: 0.6, h: 0.4, w: 3.5 }), TITLE_STYLE));
    slide.addMedia({
        x: 9.33,
        y: 1.0,
        h: 3.5,
    ...
    if (typeof window !== 'undefined' &&
        window.location.href.indexOf('gitbrent') > 0) {
        // TEST USING LOCAL FILES (OFFICE.COM)
        slide.addText('Audio: MP3 (path:"../media")', {
            x: 0.5,
            y: 4.6,
            w: 4.0,
            h: 0.4,
...
function genSlide03(pptx) {
    ...
    slide.addTable([
        [
            {
                text: 'Media Examples: YouTube Embed',
                options: BASE_TEXT_OPTS_L,
            },
            BASE_TEXT_OPTS_R,
        ],
    ], BASE_TABLE_OPTS);
    slide.addText('Online: YouTube', __assign({ x: 0.5, y: 0.75, h: 5.6, w: 12.3 }, TITLE_STYLE));
    ...
    slide.addMedia({
        ...
        w: 9.1,
        type: 'online',
        link: 'https://www.youtube.com/embed/g36-noRtKR4',
        cover: COVER_YOUTUBE,
    });
    slide.addText([
        {
    ...
    ], __assign(__assign(__assign(__assign({}, BASE_CODE_OPTS), { x: 0.5, y: 6.35, h: 0.4, w: 12.3 }), CODE_STYLE), { align: 'center' }));
    // FOOTER
 ...
 * @param {PptxGenJS} pptx
 */
export function genSlide_Test_LargeMedia(pptx) {
    var slide = pptx.addSlide({ sectionTitle: 'Media' });
    slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-media.html');
    slide.addTable([
        [
            {
                text: 'Media: Test: Large Files Only Added Once',
                options: BASE_TEXT_OPTS_L,
            },
            BASE_TEXT_OPTS_R,
        ],
    ...
    slide.addMedia({
        ...
        h: 3.38,
        type: 'video',
        path: "".concat(typeof window === 'undefined' ? '..' : '').concat(IMAGE_PATHS.big_earth_mp4.path), // NOTE: Node will throw exception when using "/" path
        cover: COVER_VIDEO_16X9,
    });
    slide.addMedia({
        x: 6.83,
...
//# sourceMappingURL=demo_media.js.map