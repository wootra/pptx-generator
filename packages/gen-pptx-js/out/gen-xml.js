...
import { BULLET_TYPES, CRLF, DEF_BULLET_MARGIN, DEF_CELL_MARGIN_IN, DEF_PRES_LAYOUT_NAME, DEF_TEXT_GLOW, DEF_TEXT_SHADOW, EMU, LAYOUT_IDX_SERIES_BASE, PLACEHOLDER_TYPES, SLDNUMFLDID, SLIDE_OBJECT_TYPES, } from './core-enums';
    ...
    slide._slideObjects.forEach(function (slideItemObj, idx) {
        ...
        if (slide._slideLayout !== undefined &&
            ...
            placeholderObj = slide._slideLayout._slideObjects.filter(function (object) {
                return object.options.placeholder ===
                    slideItemObj.options.placeholder;
            })[0];
        }
        // A: Set option vars
        ...
        switch (slideItemObj._type) {
            case SLIDE_OBJECT_TYPES.table:
                ...
                arrTabRows[0].forEach(function (cell) {
                    ...
                    intColCnt += (cellOpts === null || cellOpts === void 0 ? void 0 : cellOpts.colspan)
                ...
                */
                ...
                arrTabRows.forEach(function (cells) {
                    ...
                    var _loop_1 = function (cIdx) {
                        ...
                        if (colspan && colspan > 1) {
                            var vMergeCells = new Array(colspan - 1)
                                .fill(undefined)
                                .map(function (_) {
                                return {
                ...
                arrTabRows.forEach(function (cells, rIdx) {
                    ...
                    else if (slideItemObj.options.cy ||
                    ...
                    cells.forEach(function (cellObj) {
                        ...
                        var cell = cellObj;
                        var cellSpanAttrs = {
                            rowSpan: ((_a = cell.options) === null || _a === void 0 ? void 0 : _a.rowspan) > 1
                                ? cell.options.rowspan
                                : undefined,
                            gridSpan: ((_b = cell.options) === null || _b === void 0 ? void 0 : _b.colspan) > 1
                        ...
                        var cellValign = cellOpts.valign
                            ...
                            : '';
                        var cellTextDir = cellOpts.textDirection &&
                            cellOpts.textDirection !== 'horz'
                        ...
                        var fillColor = ((_d = (_c = cell._optImp) === null || _c === void 0 ? void 0 : _c.fill) === null || _d === void 0 ? void 0 : _d.color)
                            ...
                            : ((_e = cell._optImp) === null || _e === void 0 ? void 0 : _e.fill) &&
                                typeof cell._optImp.fill === 'string'
                                ? cell._optImp.fill
                                : '';
                        fillColor =
                            fillColor || cellOpts.fill ? cellOpts.fill : '';
                        var cellFill = fillColor
                        ...
                        if (cellOpts.border && Array.isArray(cellOpts.border)) {
                            ...
                            [
                                ...
                                if (cellOpts.border[obj.idx].type !== 'none') {
                                    ...
                                    strXml += "<a:prstDash val=\"".concat(cellOpts.border[obj.idx].type === 'dash'
                                        ? 'sysDash'
                                        : 'solid', "\"/><a:round/><a:headEnd type=\"none\" w=\"med\" len=\"med\"/><a:tailEnd type=\"none\" w=\"med\" len=\"med\"/>");
            ...
            case SLIDE_OBJECT_TYPES.placeholder:
                ...
                strSlideXml +=
                    '<p:cNvSpPr' +
                        (((_e = slideItemObj.options) === null || _e === void 0 ? void 0 : _e.isTextBox) ? ' txBox="1"/>' : '/>');
...
function genXmlParagraphProperties(textObj, isDefault) {
    ...
    // A: Build paragraphProperties
    {
        ...
        if (typeof textObj.options.bullet === 'object') {
            ...
            if (textObj.options.bullet.type) {
                if (textObj.options.bullet.type.toString().toLowerCase() ===
                    'number') {
                    paragraphPropXml += " marL=\"".concat(textObj.options.indentLevel &&
                        textObj.options.indentLevel > 0
                        ? bulletMarL +
                            bulletMarL * textObj.options.indentLevel
        ...
        // OPTION: tabStops
        if (textObj.options.tabStops &&
            Array.isArray(textObj.options.tabStops)) {
...
function genXmlTextRunProperties(opts, isDefault) {
    ...
    if (opts.hyperlink) {
        if (typeof opts.hyperlink !== 'object')
            ...
            runProps += "<a:hlinkClick r:id=\"rId".concat(opts.hyperlink._rId, "\" invalidUrl=\"\" action=\"\" tgtFrame=\"\" tooltip=\"").concat(opts.hyperlink.tooltip
                ? encodeXmlEntities(opts.hyperlink.tooltip)
                : '', "\" history=\"1\" highlightClick=\"0\" endSnd=\"0\"").concat(opts.color ? '>' : '/>');
        }
        else if (opts.hyperlink.slide) {
            runProps += "<a:hlinkClick r:id=\"rId".concat(opts.hyperlink._rId, "\" action=\"ppaction://hlinksldjump\" tooltip=\"").concat(opts.hyperlink.tooltip
                ? encodeXmlEntities(opts.hyperlink.tooltip)
                : '', "\"").concat(opts.color ? '>' : '/>');
        }
        if (opts.color) {
...
function genXmlBodyProperties(slideObject) {
    ...
    if (slideObject &&
        ...
        if (slideObject.options._bodyProp.anchor)
            bodyProperties +=
                ' anchor="' + slideObject.options._bodyProp.anchor + '"'; // VALS: [t,ctr,b]
        if (slideObject.options._bodyProp.vert)
            bodyProperties +=
                ' vert="' + slideObject.options._bodyProp.vert + '"'; // VALS: [eaVert,horz,mongolianVert,vert,vert270,wordArtVert,wordArtVertRtl]
    ...
    */
    ...
    tmpTextObjects.forEach(function (itext, idx) {
        ...
        if (!itext.text)
            itext.text = '';
        // A: Set options
        itext.options = (_b = (_a = itext.options) !== null && _a !== void 0 ? _a : opts) !== null && _b !== void 0 ? _b : {};
    ...
    arrTextObjects.forEach(function (textObj, idx) {
        ...
        if (arrTexts.length > 0 && (((_a = textObj.options) === null || _a === void 0 ? void 0 : _a.align) || opts.align)) {
            // Only start a new paragraph when align *changes*
            if (((_b = textObj.options) === null || _b === void 0 ? void 0 : _b.align) !==
                ((_c = arrTextObjects[idx - 1].options) === null || _c === void 0 ? void 0 : _c.align)) {
                arrLines.push(arrTexts);
                arrTexts = [];
            }
        }
        else if (arrTexts.length > 0 &&
            ((_d = textObj.options) === null || _d === void 0 ? void 0 : _d.bullet) &&
            arrTexts.length > 0) {
            arrLines.push(arrTexts);
            arrTexts = [];
        ...
        if (arrTexts.length > 0 && ((_e = textObj.options) === null || _e === void 0 ? void 0 : _e.breakLine)) {
    ...
    arrLines.forEach(function (line) {
        ...
        line.forEach(function (textObj, idx) {
            ...
            Object.entries(opts)
                ...
                return !(((_b = textObj.options) === null || _b === void 0 ? void 0 : _b.hyperlink) && key === 'color');
            })
                .forEach(function (_a) {
                var _b;
                ...
                if (key !== 'bullet' &&
                    !((_b = textObj.options) === null || _b === void 0 ? void 0 : _b[key])) {
                    // @ts-ignore
            ...
            if ((!textObj.text && opts.fontSize) || ((_a = textObj.options) === null || _a === void 0 ? void 0 : _a.fontSize)) {
                reqsClosingFontSize = true;
                opts.fontSize = opts.fontSize || ((_b = textObj.options) === null || _b === void 0 ? void 0 : _b.fontSize);
            }
        });
...
export function genXmlPlaceholder(placeholderObj) {
    ...
    var placeholderTyp = ((_b = placeholderObj.options) === null || _b === void 0 ? void 0 : _b._placeholderType)
        ...
        : '';
    var placeholderType = placeholderTyp &&
        PLACEHOLDER_TYPES[placeholderTyp]
...
export function makeXmlContTypes(slides, slideLayouts, masterSlide) {
    ...
    // STEP 6: Add rels
    ((_a = masterSlide === null || masterSlide === void 0 ? void 0 : masterSlide._relsChart) !== null && _a !== void 0 ? _a : []).forEach(function (rel) {
        strXml +=
            ' <Override PartName="' +
                rel.Target +
                '" ContentType="application/vnd.openxmlformats-officedocument.drawingml.chart+xml"/>';
    });
    ((_b = masterSlide === null || masterSlide === void 0 ? void 0 : masterSlide._relsMedia) !== null && _b !== void 0 ? _b : []).forEach(function (rel) {
        if (rel.type !== 'image' &&
            rel.type !== 'online' &&
            rel.type !== 'chart' &&
            rel.extn !== 'm4v' &&
 ...
 * @return {string} XML
 */
export function makeXmlSlide(slide) {
 ...
 */
export function getNotesFromSlide(slide) {
    var _a;
    var notesText = '';
    ((_a = slide._slideObjects) !== null && _a !== void 0 ? _a : []).forEach(function (data) {
 ...
 * @return {string} XML
 */
export function makeXmlNotesSlide(slide) {
 ...
 * @return {string} XML
 */
export function makeXmlLayout(layout) {
 ...
 * @return {string} XML
 */
export function makeXmlMaster(slide, layouts) {
    ...
    strXml +=
        '<p:sldLayoutIdLst>' + layoutDefs.join('') + '</p:sldLayoutIdLst>';
 ...
 * @return {string} XML
 */
export function makeXmlMasterRel(masterSlide, slideLayouts) {
...
function getLayoutIdxForSlide(slides, slideLayouts, slideNumber) {
    ...
    for (var i = 0; i < slideLayouts.length; i++) {
        if (slideLayouts[i]._name ===
            ((_a = slides[slideNumber - 1]._slideLayout) === null || _a === void 0 ? void 0 : _a._name)) {
            return i + 1;
        }
    }
 ...
 * @return {string} XML
 */
export function makeXmlTheme(pres) {
    var _a, _b, _c, _d;
 ...
 * @return {string} XML
 */
export function makeXmlPresentation(pres) {
...
export function correctShadowOptions(shadowProps) {
    ...
    if (shadowProps.angle) {
        // A: REALITY-CHECK
        if (isNaN(Number(shadowProps.angle)) ||
            shadowProps.angle < 0 ||
    ...
    if (shadowProps.opacity) {
        // A: REALITY-CHECK
        if (isNaN(Number(shadowProps.opacity)) ||
