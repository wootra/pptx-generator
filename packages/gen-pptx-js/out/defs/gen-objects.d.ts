 ...
 */
export declare function addShapeDefinition(target: PresSlide, shapeName: SHAPE_NAME, opts: ShapeProps | undefined): void;
/**
 ...
 */
export declare function addTableDefinition(target: PresSlide, tableRows: TableRow[], options: TableProps | undefined, slideLayout: SlideLayout | null, presLayout: PresLayout, addSlide: (options?: AddSlideProps) => PresSlide, getSlide: (slideNumber: number) => PresSlide): PresSlide[];
/**
 ...
 * @since: 1.0.0
 */
export declare function addTextDefinition(target: PresSlide, text: TextProps[], opts: TextPropsOptions | undefined, isPlaceholder: boolean): void;
/**
 ...
 */
export declare function addBackgroundDefinition(props: BackgroundProps | undefined, target: PresSlide | SlideLayout): void;
